...
Usage::
    ...
    py AI/Dev/RE/sub_probe.py
    py AI/Dev/RE/sub_probe.py --port COM3
    py AI/Dev/RE/sub_probe.py --skip-2letter   # quick single + 3-letter only
    py AI/Dev/RE/sub_probe.py --only-targeted  # only the seeded 3-letter list

Outputs::
    AI/Dev/RE/sessions/sub_probe_<timestamp>.txt           (raw log)
    AI/Dev/RE/sessions/sub_probe_<timestamp>.summary.md    (hits table)
"""
...
# Source: AI/Dev/RE/firmware_analysis/sub_1.03.15.strings.txt content
...
# firmware format strings (see AI/Dev/RE/sub_command_response_map.md).
