...
``POF``). Both spec PDFs are mirrored at ``AI/Dev/RE/`` in this repo.
...
Usage::
    ...
    py AI/Dev/RE/serial_probe.py --port COM4
    py AI/Dev/RE/serial_probe.py --mode poll --poll-cmd GLG --poll-duration 30
    py AI/Dev/RE/serial_probe.py --mode diff --diff-cmd STS
...
QUERIES: List[tuple[str, str]] = [
    ...
    # AI/Dev/RE/BCDx36HP_RemoteCommand_Specification_V1_05.txt:
