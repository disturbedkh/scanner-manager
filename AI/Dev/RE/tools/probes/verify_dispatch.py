...
Output: ``AI/Dev/RE/sessions/dispatch_verification_<UTC-ts>.md``.
...
Usage::
    ...
    py AI/Dev/RE/tools/probes/verify_dispatch.py
    py AI/Dev/RE/tools/probes/verify_dispatch.py --port COM5
    py AI/Dev/RE/tools/probes/verify_dispatch.py --candidates path/to/list.txt
