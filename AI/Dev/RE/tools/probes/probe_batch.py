...
::
    ...
    py AI/Dev/RE/tools/probes/probe_batch.py
    py AI/Dev/RE/tools/probes/probe_batch.py --tag round4_first_pass
    # Override - send everything to a specific device:
    py AI/Dev/RE/tools/probes/probe_batch.py --port COM5
    py AI/Dev/RE/tools/probes/probe_batch.py --allow-destructive
    py AI/Dev/RE/tools/probes/probe_batch.py --baud 115200

Outputs a timestamped markdown report under
``AI/Dev/RE/sessions/probe_batch_<UTC-ts>.md`` plus a JSONL log next to it.
