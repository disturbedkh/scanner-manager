...
#
# Outputs:
#   AI\Dev\RE\sessions\sds100_sd_inventory_<UTC-ts>.md      - top-level summary
#   AI\Dev\RE\sessions\sds100_sd_inventory_<UTC-ts>.tsv     - full file list
#   AI\Dev\RE\sessions\sds100_sd_boot_sector.bin            - first 512 bytes of the volume
#
# Usage (in PowerShell):
#   .\AI\Dev\RE\_dump_sd_inventory.ps1            # auto-detect drive
#   .\AI\Dev\RE\_dump_sd_inventory.ps1 -Drive E:  # explicit drive
...
$sessions = Join-Path $repoRoot "AI\Dev\RE\sessions"
