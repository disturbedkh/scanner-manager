...
| Artifact | Used for |
|---|---|
| `wiki/RE-SD-Card.md` + `AI/Dev/RE/docs/SD_CARD_COMPARISON.md` | favorites/HPDB schema we already parse end-to-end |
| `AI/Dev/RE/docs/sentinel_api.md` | the file-set we'd round-trip with for "virtual sentinel" of our own |
| `AI/Dev/RE/docs/SDS100_unofficial_commands.md` (GLT/GSI/STS) | UI/UX surface to mirror in software |
| `AI/Dev/RE/docs/sub_command_dispatch.md` (DSP debug commands) | informs Tier C only |
| `AI/Dev/RE/docs/sub_static_analysis.md` (R840/FFT format strings) | informs Tier C only |
