...
| `docs/adding-a-scanner.md` | Step-by-step guide for adding a new profile. |
...
3. **Second profile - SDS100 (and SDS200).** Add `Sds100Profile` to
   ...
   `AI/Dev/RE/SDS100.md`; that doc's "What to change in the
   ...
   Follow `docs/adding-a-scanner.md` for the public-doc checklist;
   follow `AI/Dev/RE/SDS100.md` for the actual data and field
   shapes.
