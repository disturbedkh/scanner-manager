...
This file is intentionally generic - real machine entries are kept
locally only (the original contributor's entries were stripped before
the repo went public). Treat this page as a template + a place to
share dev-environment quirks that future contributors will hit.
