...
_BOUND_INSTANCE_METHODS = (
    ...
    "_reinsert_entry_from_payload", "_reinsert_group_from_payload",
    "_revert_import_apply",
    "_do_edit_entry", "_do_set_service",
    "_do_add_cfreq", "_do_add_cgroup",
    "_log_add_entry", "_log_add_group",
    "_do_edit_system", "_do_delete_system",
    "_capture_baselines",
    "_ensure_system_baseline",
    "_ensure_group_baseline",
    "_ensure_entry_baseline",
    "_metastore_revert_ops",
    "revert_event",
