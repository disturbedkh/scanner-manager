...
_TARGET_MODEL_ALIASES: Sequence[str] = (
    # Real BT885 firmware writes ``TargetModel\tBCDx36HP`` (verified
    # 2026-04-27 — see Metacache/Dev/RE/docs/BT885.md). Stale
    # ``Beartracker885`` aliases were removed; model identity is
    # disambiguated via ``scanner.inf`` Scanner field 1 (``BT885-SCN``).
    "BT885",
    "BCDx36HP",
)
