...
Downgrade from 1.03.06 to 1.03.05.  
(This sub is compatible with main V1.23.05 and above)
...
> Downgrade from V1.03.06.
Copy and paste "SDS-100-SUB_V1_03_05.firm" files to this folder.
 ...
 L activity_log
   ...
   firmware <--- Open this folder.
    L CitiTable_V00_00.dat <-- Do not touch.  
      ...
      SDS-100-SUB_V1_03_05.firm <-- Copy sub firmware to here*.

++++++++++++++++++++
* Do not upload multiple sub firmware. 
