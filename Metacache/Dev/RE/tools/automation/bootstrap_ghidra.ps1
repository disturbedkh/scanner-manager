...
# in the current PowerShell session: . .\Metacache\Dev\RE\tools\automation\.ghidra_env.ps1
...
Write-Host ''
Show-OK "Bootstrap complete. Next: run Metacache\Dev\RE\tools\automation\fetch_lpc43xx_svd.ps1 if LPC43xx.svd is missing."
