...
Usage::
    ...
    py Metacache/Dev/RE/tools/firmware/firmware_structure.py
    py Metacache/Dev/RE/tools/firmware/firmware_structure.py --image main_2.00.00=path/to/V2_00_00.bin
"""
