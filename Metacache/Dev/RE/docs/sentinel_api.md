...
Get-ChildItem -Path E:\ -Recurse -File | Select-Object FullName, Length, LastWriteTime > Metacache\Dev\RE\sessions\sds100_sd_inventory.txt
Get-Content E:\Internal\GlobalSetting.cfg | Out-File Metacache\Dev\RE\sessions\sds100_global_setting.txt
```
