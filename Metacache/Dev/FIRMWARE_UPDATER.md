...
> References: `Metacache/Dev/RE/SDS100.md` "Firmware update mechanism"
...
- **Direct USB-bootloader flashing** (PID 0x0019 is NOT a bootloader
  - that earlier hypothesis was wrong; see `Metacache/Dev/RE/SDS100.md`
  Session 4 "Bombshell" section).
- **Firmware decryption / static RE on Main** (Main is encrypted at
  rest, see `Metacache/Dev/RE/SDS100_firmware.md`).
